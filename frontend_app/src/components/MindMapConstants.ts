...
export const POPULAR_ICONS: string[] = [
  'Star', 'Heart', 'Flag', 'Bookmark', 'Bell',
  'Clock', 'Calendar', 'Zap', 'Target', 'Award',
  'Lightbulb', 'Rocket', 'Bug', 'Shield', 'Lock',
  'Unlock', 'Eye', 'Check', 'X', 'AlertTriangle',
  'Info', 'HelpCircle', 'MessageCircle', 'Mail', 'Phone',
  'MapPin', 'Home', 'Building', 'User', 'Users',
  'Settings', 'Wrench', 'Database', 'Server', 'Cloud',
  'Wifi', 'Globe', 'Link', 'Paperclip', 'File',
  'FileText', 'Folder', 'Image', 'Camera', 'PlayCircle',
